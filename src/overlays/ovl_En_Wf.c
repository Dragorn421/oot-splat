...
s32 func_80B33FB0(GlobalContext* globalCtx, EnWf* this, s16 arg2) {
    ...
    if (func_800354B4(globalCtx, &this->actor, 100.0f, 0x5DC0, 0x2AA8, this->actor.shape.rot.y) != 0) {
        ...
        if ((this->actor.xzDistToPlayer < 80.0f) && (globalCtx->gameplayFrames & 1)) {
            func_80B36288(this);
            return 1;
        }
        func_80B35B94(this);
    ...
    if (arg2 != 0) {
        ...
        if (this->actor.xzDistToPlayer <= 80.0f) {
            if (Actor_OtherIsTargeted(globalCtx, &this->actor) == 0) {
                ...
                if ((globalCtx->gameplayFrames & 7) || (ABS(temp_v1_3) < 0x38E0)) {
                    func_80B35540(this);
                    return 1;
                }
            }
...
void func_80B3487C(EnWf* this, GlobalContext* globalCtx) {
    ...
    sp50_real = 0.0f;
    sp48_real = GET_PLAYER(globalCtx);
    if (func_80B37830(globalCtx, this) == 0) {
...
void func_80B35024(EnWf* this, GlobalContext* globalCtx) {
    ...
    if ((func_80B37830(globalCtx, this) == 0) && (func_80B33FB0(globalCtx, this, 0) == 0)) {
        ...
        if ((Math_CosS(sp56_real - this->actor.shape.rot.y) < -0.85f) &&
            !Actor_OtherIsTargeted(globalCtx, &this->actor) && (this->actor.xzDistToPlayer <= 80.0f)) {
            func_80B35540(this);
        } else {
            this->unk2E8 -= 1;
            if (this->unk2E8 == 0) {
...
void func_80B355BC(EnWf* this, GlobalContext* globalCtx) {
    ...
    if (((var_a2_sp3C == 0xF) && !Actor_IsTargeted(globalCtx, &this->actor) &&
    ...
    if (SkelAnime_Update(&this->unk188)) {
        ...
        if ((ABS(temp_v0_2) <= 0x4000) && (this->actor.xzDistToPlayer < 60.0f) &&
            ...
            if (func_800354B4(globalCtx, &this->actor, 100.0f, 0x2710, 0x4000, this->actor.shape.rot.y) != 0) {
                ...
                if (!Actor_OtherIsTargeted(globalCtx, &this->actor) &&
                    ((globalCtx->gameplayFrames & 1) || (ABS(temp_a2_sp2C) < 0x38E0))) {
                    func_80B35540(this);
                } else {
                    func_80B34F28(this);
                }
...
void func_80B36D3C(EnWf* this, GlobalContext* globalCtx) {
    ...
    for (var_s0 = ((s32)this->unk188.animLength - this->unk2E8) >> 1; var_s0 >= 0; var_s0--) {
        ...
        EffectSsDeadDb_Spawn(globalCtx, &sp88, &sp7C, &sp7C, 100, 0, 255, 255, 255, 255, 0, 0, 255, 1, 9, 1);
    }
}
...
s32 func_80B37454(GlobalContext* globalCtx, s32 arg1, Gfx** arg2, Vec3f* arg3, Vec3s* arg4, void* thisx) {
    EnWf* this = thisx;
...
void func_80B37494(GlobalContext* globalCtx, s32 arg1, Gfx** arg2, Vec3s* arg3, void* thisx) {
    EnWf* this = thisx;
    s32 var_v1_sp30;
    Vec3f sp24;
    Vec3f sp18;
...
void EnWf_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((this->unk2D4 != 0) || (this->unk300 == 0)) {
        ...
        SkelAnime_DrawFlexOpa(globalCtx, this->unk188.skeleton, this->unk188.jointTable, this->unk188.dListCount,
        ...
        if (this->unk2E4 != 0) {
            ...
            if ((this->unk2E4 & 3) == 0) {
                ...
                EffectSsEnFire_SpawnVec3s(globalCtx, &this->actor, &this->unk14C[v], 75, 0, 0, v);
            }
        }
    }
