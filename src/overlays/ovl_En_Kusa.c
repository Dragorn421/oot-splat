...
void func_80A9AFA0(EnKusa* this, void (*actionFunc)(EnKusa*, GlobalContext*)) {
    this->unk19C = 0;
...
s32 func_80A9AFAC(EnKusa* this, GlobalContext* globalCtx, f32 arg2) {
    ...
    temp_fv0 = func_8003C9A4(&globalCtx->colCtx, &sp38, &sp28, &this->actor, (Vec3f*)&sp2C);
...
void func_80A9B07C(EnKusa* this, GlobalContext* globalCtx) {
    ...
    switch (this->actor.params & 3) {
        ...
        case 2:
            ...
            Item_DropCollectibleRandom(globalCtx, NULL, &this->actor.posRot.pos, (s16)(var_v0 * 0x10));
            break;
        case 1:
...
void func_80A9B21C(EnKusa* this, GlobalContext* globalCtx) {
    ...
    for (i = 0; i < ARRAY_COUNT(D_80A9C23C); i++) {
        ...
        EffectSsKakera_Spawn(globalCtx, (Vec3f*)&spB8, (Vec3f*)&spC4, (Vec3f*)&spB8, -0x64, 0x40, 0x28, 3, 0,
                             (s16)(s32)D_80A9C26C[new_var], 0, 0, 0x50, -1, 1, D_40355E0);
        ...
        new_var = (s32)(Math_Rand_ZeroOne() * 111.1f) % 7;
        EffectSsKakera_Spawn(globalCtx, (Vec3f*)&spB8, (Vec3f*)&spC4, (Vec3f*)&spB8, -0x64, 0x40, 0x28, 3, 0,
                             (s16)(s32)D_80A9C26C[new_var], 0, 0, 0x50, -1, 1, D_40356A0);
        var_s1++;
    }
}
...
void func_80A9B574(EnKusa* this, GlobalContext* globalCtx) {
    ...
    for (var_s0 = 0; var_s0 < 3; var_s0++) {
        if (Actor_Spawn(&globalCtx->actorCtx, globalCtx, 0x20, this->actor.posRot.pos.x, this->actor.posRot.pos.y,
                        this->actor.posRot.pos.z, 0, (s16)(s32)(Math_Rand_ZeroOne() * 65535.0f), 0, 1) == NULL) {
            break;
        }
    }
}
...
void EnKusa_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actor.shape.rot.y == 0) {
        temp_ft3 = (s32)Math_Rand_ZeroFloat(65536.0f);
        this->actor.posRot.rot.y = (s16)temp_ft3;
        this->actor.initPosRot.rot.y = (s16)temp_ft3;
        this->actor.shape.rot.y = (s16)temp_ft3;
    }
...
void func_80A9B810(EnKusa* this, GlobalContext* globalCtx) {
    if (Object_IsLoaded(&globalCtx->objectCtx, (s32)this->unk19E)) {
...
void func_80A9B8D8(EnKusa* this, GlobalContext* globalCtx) {
    ...
    if (Actor_HasParent(&this->actor, globalCtx) != 0) {
        func_80A9BA98(this);
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.posRot.pos, 0x14, 0x869U);
        return;
    }
    temp_v0 = this->unk150.base.acFlags;
    if (temp_v0 & 2) {
        this->unk150.base.acFlags = temp_v0 & 0xFFFD;
        func_80A9B21C(this, globalCtx);
        func_80A9B07C(this, globalCtx);
        Audio_PlaySoundAtPosition(globalCtx, &this->actor.posRot.pos, 0x14, 0x284EU);
        if (((s16)this->actor.params >> 4) & 1) {
    ...
    temp_v0_2 = this->unk150.base.ocFlags1;
    if (!(temp_v0_2 & 8) && (this->actor.xzDistFromLink > 12.0f)) {
        this->unk150.base.ocFlags1 = temp_v0_2 | 8;
    }
...
void func_80A9BAD8(EnKusa* this, GlobalContext* globalCtx) {
    if (Actor_HasNoParent(&this->actor, globalCtx) != 0) {
        ...
        this->actor.collideData.mass = 0xF0;
...
void func_80A9BC1C(EnKusa* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.bgCheckFlags & 0xB) {
        ...
        if (this->actor.bgCheckFlags & 0x40) {
            ...
            EffectSsGRipple_Spawn(globalCtx, (Vec3f*)&sp30, 0x96, 0x28A, 0);
            EffectSsGRipple_Spawn(globalCtx, (Vec3f*)&sp30, 0x190, 0x320, 4);
            EffectSsGRipple_Spawn(globalCtx, (Vec3f*)&sp30, 0x1F4, 0x44C, 8);
            ...
            Audio_PlaySoundAtPosition(globalCtx, &this->actor.posRot.pos, 0x28, 0x28C5U);
        }
        func_80A9B140(this);
...
void func_80A9BFA8(EnKusa* this, GlobalContext* globalCtx) {
    if ((this->unk19C >= 0x79) && (Math_ApproxF(&this->actor.posRot.pos.y, this->actor.initPosRot.pos.y, 0.6f) != 0) &&
        (this->unk19C >= 0xAA)) {
        func_80A9C00C(this);
    }
}
