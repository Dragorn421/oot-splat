...
#pragma GLOBAL_ASM("asm/non_matchings/overlays/ovl_Bg_Po_Syokudai/BgPoSyokudai_Init.s")

#pragma GLOBAL_ASM("asm/non_matchings/overlays/ovl_Bg_Po_Syokudai/BgPoSyokudai_Destroy.s")

#pragma GLOBAL_ASM("asm/non_matchings/overlays/ovl_Bg_Po_Syokudai/BgPoSyokudai_Update.s")

#pragma GLOBAL_ASM("asm/non_matchings/overlays/ovl_Bg_Po_Syokudai/BgPoSyokudai_Draw.s")
