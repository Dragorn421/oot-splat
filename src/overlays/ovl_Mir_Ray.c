...
void func_80B8D050(MirRay* this) {
    ...
    (&this->unk14C.elements[0])->shape.world.center.x = (s16)(s32)(this->unk27C.x + ((vec.x)));
    (&this->unk14C.elements[0])->shape.world.center.y = (s16)(s32)(this->unk27C.y + ((vec.y)));
    (&this->unk14C.elements[0])->shape.world.center.z = (s16)(s32)(this->unk27C.z + ((vec.z)));
    new_var = &this->unk14C.elements[0];
    (new_var)->shape.world.radius = (s16)(s32)((f32)temp_v0->unk14 * (new_var)->shape.unkRadiusScale);
}
...
void func_80B8D110(MirRay* this, GlobalContext* globalCtx) {
    ...
    if (func_80B8E404(&this->unk27C, &this->unk288, temp_v1->posRot.pos.x, temp_v1->posRot.pos.y + 30.0f,
                      temp_v1->posRot.pos.z, (s32)this->unk294, (s32)this->unk296) != 0) {
        if (temp_s1->unk1F & 8) {
            Math_Vec3f_Diff(&temp_v1->posRot.pos, &this->unk27C, &sp44);
        } else {
            Math_Vec3f_Diff(&this->unk288, &this->unk27C, &sp44);
        }
        sp3C.x = (s16)(s32)((temp_s1->unk18 * /*(bitwise f32) sp44*/ sp44.x) + this->unk27C.x);
        sp3C.y = (s16)(s32)((temp_s1->unk18 * sp44.y) + this->unk27C.y);
        sp3C.z = (s16)(s32)((temp_s1->unk18 * sp44.z) + this->unk27C.z);
        Math_ApproxS(&this->unk298, temp_s1->unk16, 6);
        Lights_PointNoGlowSetInfo(&this->unk2A0, sp3C.x, sp3C.y, sp3C.z, (u8)(s32)temp_s1->unk1C.r,
                                  (u8)(s32)temp_s1->unk1C.g, (u8)(s32)temp_s1->unk1C.b, (s16)(s32)this->unk298);
        return;
    }
...
void MirRay_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->unk27C.x = (f32)temp_s1->unk0.x;
    this->unk27C.y = (f32)temp_s1->unk0.y;
    this->unk27C.z = (f32)temp_s1->unk0.z;
    this->unk294 = temp_s1->unkC;
    this->unk288.x = (f32)temp_s1->unk6.x;
    this->unk288.y = (f32)temp_s1->unk6.y;
    this->unk288.z = (f32)temp_s1->unk6.z;
    ...
    if (temp_s1->unk1F & 2) {
        Collider_InitSpheres(globalCtx, temp_a1);
        Collider_LoadSpheres(globalCtx, temp_a1, &this->actor, &D_80B8E6E8, &this->unk16C);
        if (!(temp_s1->unk1F & 4)) {
            func_80B8D050(this);
        }
    }
...
void MirRay_Destroy(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (*(&D_80B8E6F8->unk1F + (this->actor.params << 5)) & 2) {
...
void func_80B8D6F0(MirRay* this, GlobalContext* globalCtx) {
    ...
    temp_v1 = globalCtx->actorCtx.actorList[2].first;
    this->unk22C = 0.0f;
    temp_v0 = &temp_v1->shieldMf;
    if (func_80B8E404(&this->unk27C, &this->unk288, temp_v1->shieldMf.wx, temp_v1->shieldMf.wy, temp_v1->shieldMf.wz,
                      (s32)this->unk294, (s32)this->unk296) != 0) {
        temp_fv0 = sqrtf((temp_v0->zz * temp_v0->zz) + ((temp_v0->zx * temp_v0->zx) + (temp_v0->zy * temp_v0->zy)));
        if (temp_fv0 == 0.0f) {
            this->unk278 = 1.0f;
        } else {
            this->unk278 = 1.0f / temp_fv0;
        }
        if (*(&D_80B8E6F8->unk1F + (this->actor.params << 5)) & 1) {
            this->unk22C = 1.0f;
            return;
        }
        ...
        sp4C = sp4C;
        temp_fv1_2 = ((-temp_v0->zx * sp4C.x) - (temp_v0->zy * sp4C.y)) - (sp4C.z * temp_v0->zz);
        if (temp_fv1_2 < 0.0f) {
...
void func_80B8DA78(struct_80B8D8A0* arg0) {
    ...
    for (var_v0 = 0; var_v0 < 6; var_v0++) {
        for (var_v1 = var_v0 + 1; var_v1 < 6; var_v1++) {
            if (arg0[var_v0].unk4C != NULL) {
                if (arg0[var_v1].unk4C != NULL) {
                    if (ABS(arg0[var_v0].unk4C->unk8 - arg0[var_v1].unk4C->unk8) < 0x64) {
                        if (ABS(arg0[var_v0].unk4C->unkA - arg0[var_v1].unk4C->unkA) < 0x64) {
                            if ((ABS(arg0[var_v0].unk4C->unkC - arg0[var_v1].unk4C->unkC) < 0x64) &&
                                (arg0[var_v0].unk4C->unkE == arg0[var_v1].unk4C->unkE)) {
                                arg0[var_v1].unk4C = NULL;
                            }
                        }
                    }
                }
...
void func_80B8DB7C(MirRay* this, GlobalContext* globalCtx, struct_80B8D8A0* arg2) {
    ...
    func_80062734(&this->unk1AC, (Vec3f*)&spCC, (Vec3f*)&sp130, (Vec3f*)&spC0, (Vec3f*)&sp124);
    for (var_s2 = 0; var_s2 < 6; var_s2++) {
        new_var = &spDC.x; //! FAKE
        var_s0 = &arg2[var_s2];
        if (var_s0->unk4C != NULL) {
            if (&spE8) {} //! FAKE
            spDC.x = (f32)var_s0->unk4C->unk8 * 0.00003051851f;
            spDC.y = (f32)var_s0->unk4C->unkA * 0.00003051851f;
            spDC.z = (f32)var_s0->unk4C->unkC * 0.00003051851f;
            if (Math3D_LineSegVsPlane(*new_var, spDC.y, spDC.z, (f32)var_s0->unk4C->unkE, (Vec3f*)&sp130,
                                      (Vec3f*)&sp124, &sp118, 1) != 0) {
                var_s0->unk0 = /*(bitwise f32) sp118*/ sp118.x;
                var_s0->unk4 = sp118.y;
                var_s0->unk8 = sp118.z;
                ...
                if (Math3D_LineSegVsPlane(spDC.x, spDC.y, spDC.z, (f32)var_s0->unk4C->unkE, (Vec3f*)&sp10C,
                                          (Vec3f*)&sp100, &spF4, 1) != 0) {
                    do {
                    } while (0); //! FAKE
                    var_s0->unkC.xx = /*(bitwise f32)spF4*/ spF4.x - /*(bitwise f32)sp118*/ sp118.x;
...
void MirRay_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->unk22C = 0.0f;
    if ((D_80B8E670 == 0) && (this->unk2AE == 0) && (Player_HasMirrorShieldSetToDraw(globalCtx) != 0)) {
        Matrix_Mult(&temp_s0->shieldMf, 0U);
        func_80B8D6F0(this, globalCtx);
        if (!(this->unk22C <= 0.0f)) {
            OPEN_DISPS(globalCtx->state.gfxCtx, "../z_mir_ray.c", 0x3C6);
            func_80093D84(globalCtx->state.gfxCtx);
            Matrix_Scale(1.0f, 1.0f, this->unk22C * 5.0f, 1U);
            ...
            for (i = 0; i < ARRAY_COUNT(sp7C); i++) {
                if (sp7C[i].unk4C != NULL) {
                    Matrix_Translate(sp7C[i].unk0, sp7C[i].unk4, sp7C[i].unk8, 0U);
                    Matrix_Scale(0.01f, 0.01f, 0.01f, 1U);
                    Matrix_Mult(&sp7C[i].unkC, 1U);
...
s32 func_80B8E404(Vec3f* arg0, Vec3f* arg1, f32 arg2, f32 arg3, f32 arg4, s32 arg5, s32 arg6) {
    ...
    if ((SQ(sp80_x - arg2) + SQ(sp7C_y - arg3) + SQ(sp78_z - arg4)) <= SQ(temp_fv1_2)) {
        ...
        sp50.y = arg3 - arg0->y;
        sp50.z = arg4 - arg0->z;
        if (Math3D_Cos(&sp5C, (Vec3f*)&sp50) < 0.0f) {
            return 0;
        }
        sp44.x = arg2 - arg1->x;
        sp44.y = arg3 - arg1->y;
        sp44.z = arg4 - arg1->z;
        if (Math3D_Cos(&sp5C, (Vec3f*)&sp44) > 0.0f) {
            return 0;
        }
        return 1;
    }
