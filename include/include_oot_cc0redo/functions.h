...
// ? func_80029724(?);
// ? func_8002993C(?);
void func_800299AC(GlobalContext*, Vec3f*);
// ? func_80029C50(?);
void func_80029CA4(GlobalContext*, s32, Vec3f*);
// ? func_80029F44(?);
// ? func_8002A32C(?);
// ? func_8002A3C4(?);
...
// ? func_8005B65C_InitCollider(?);
// ? func_8005B6B0_LoadColliderAltWithActor(?);
s32 func_8005B72C_LoadCollider(GlobalContext* globalCtx, Collider* collision, Actor* actor, ColliderSrc* src);
void func_8005B76C_ClearColliderATHit(GlobalContext* globalCtx, Collider* collision);
void func_8005B784_ClearColliderACHit(GlobalContext* globalCtx, Collider* collision);
void func_8005B79C_ClearColliderOCHit(GlobalContext* globalCtx, Collider* collision);
// ? func_8005B7C0_InitATDmgInfo(?);
// ? func_8005B7F4_LoadATDmgInfo(?);
// ? func_8005B824_InitACDmgInfo(?);
// ? func_8005B860_LoadACDmgInfo(?);
// ? func_8005B884_InitElement(?);
s32 func_8005B93C_LoadElement(GlobalContext* globalCtx, ColliderElement* ColliderElement, ColliderElementSrc* bodyFlags);
void func_8005B9B0_ClearColliderElementATHit(GlobalContext* globalCtx, ColliderElement* body);
...
// ? func_8005BA30_InitSpheresElementShape(?);
s32 func_8005BA74_DestroySpheresElementShape(GlobalContext*, ColliderSpheresElementShape*);
// ? func_8005BA84_LoadSpheresElementShape(?);
// ? func_8005BAD8_InitSpheresElement(?);
// ? func_8005BB10_DestroySpheresElement(?);
// ? func_8005BAD8_LoadSpheresElement(?);
// ? func_8005BB8C_ClearSpheresElementATHit(?);
// ? func_8005BBB0_ClearSpheresElementACHit(?);
// ? func_8005BBD4_ClearSpheresElementOCHit(?);
// void func_8005C050_LoadSpheres(GlobalContext* globalCtx, Collider* collision, Actor* actor, UNK_TYPE arg3, UNK_TYPE arg4);
...
// ? func_8005C5B0_InitTriNorm(?);
// ? func_8005C608(?);
// ? func_8005C6C0_InitTrisElement(?);
// ? func_8005C6F8(?);
// ? func_8005C730(?);
// ? func_8005C774(?);
// ? func_8005C798_SetAC_sub_2(?);
// ? func_8005C7BC_Type2(?);
// ? func_8005CE6C_InitQuadShape(?);
// ? func_8005CEC4(?);
// ? func_8005CEDC(?);
// ? func_8005CF90_Type3(?);
