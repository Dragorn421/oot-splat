...
// ? func_8005B6B0_InitColliderAltWithActor(?);
s32 func_8005B72C_InitCollider(GlobalContext* globalCtx, Collider* collision, Actor* actor, ColliderSrc* src);
...
// ? func_8005B860(?);
// ? func_8005B884(?);
s32 func_8005B93C(GlobalContext* globalCtx, ColliderElement* ColliderElement, ColliderElementSrc* bodyFlags);
