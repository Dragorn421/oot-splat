...
// ? func_8005B860(?);
// ? func_8005B884(?);
s32 func_8005B93C(GlobalContext* globalCtx, ColliderBody* colliderBody, ColliderBodySrc* bodyFlags);
...
// void func_8005C050_Type0(GlobalContext* globalCtx, Collider* collision, Actor* actor, UNK_TYPE arg3, UNK_TYPE arg4);
// ? func_8005C2BC(?);
