...
f32 func_8003CB30(CollisionContext*, CollisionPoly*, Vec3f*);
...
u32 DynaPolyInfo_RegisterActor(GlobalContext* globalCtx, DynaCollisionContext* dynaColCtx, Actor* actor, CollisionHeader* arg3);
...
s32 func_80041D28(CollisionContext*, CollisionPoly*, u32);
...
s32 func_80041F7C(CollisionContext*, CollisionPoly*, u32);
...
s32 func_80041FE8(CollisionContext*, CollisionPoly*, u32);
s32 func_8004200C(CollisionContext*, CollisionPoly*, u32);
...
// ? Collider_InitCollider(?);
// ? Collider_LoadColliderAltWithActor(?);
s32 Collider_LoadCollider(GlobalContext* globalCtx, Collider* collision, Actor* actor, ColliderSrc* src);
void Collider_ClearColliderATHit(GlobalContext* globalCtx, Collider* collision);
void Collider_ClearColliderACHit(GlobalContext* globalCtx, Collider* collision);
void Collider_ClearColliderOCHit(GlobalContext* globalCtx, Collider* collision);
// ? Collider_InitATDmgInfo(?);
// ? Collider_LoadATDmgInfo(?);
// ? Collider_InitACDmgInfo(?);
// ? Collider_LoadACDmgInfo(?);
// ? Collider_InitElement(?);
s32 Collider_LoadElement(GlobalContext* globalCtx, ColliderElement* ColliderElement, ColliderElementSrc* bodyFlags);
void Collider_ClearElementATHit(GlobalContext* globalCtx, ColliderElement* body);
void Collider_ClearElementACHit(GlobalContext* globalCtx, ColliderElement* body);
// ? Collider_ClearElementOCHit(?);
// ? Collider_InitSpheresElementShape(?);
...
// ? func_80063828_cc0(?);
void func_8006390C_cc0(Input* input);
// ? func_80063C04_cc0(?);
void func_80063D7C_cc0(GraphicsContext* gfxCtx);
...
s32 Math3D_CylOutsideCylDist(Cylinder16* arg0, Cylinder16* arg1, f32* arg2, f32* arg3);
