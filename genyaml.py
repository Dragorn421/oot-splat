...
ok_map_p = Path("/home/dragorn421/Documents/oot/build/ntsc-1.0/oot-ntsc-1.0.map")

ok_map = mapfile_parser.MapFile()
ok_map.readMapFile(ok_map_p)
ok_map_segment_by_name = {s.name: s for s in ok_map}

ok_spec_p = Path("/home/dragorn421/Documents/oot/build/ntsc-1.0/spec")
                ...
                if segment_type == "code":
                    ...
                    for start, end, subseg_type in (
                        ...
                        if start != end:
                            ...
                            prev_end = end
                    if segment_name != "n64dd":
                        yamlprint("    find_file_boundaries: false")
                yamlprint()
